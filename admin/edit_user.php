				...
				<form id = "form_user" method = "POST" enctype = "multi-part/form-data">
					...
					<div class = "panel-body">
						<div class = "form-group">
							...
							<input class = "form-control" value = "<?php echo $fetch['username']?>" name = "username" type = "text" required data-parsley-pattern="^[a-zA-Z ]+$"data-parsley-trigger="keyup">
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">	
							...
							<input class = "form-control" name = "password"  value = "<?php echo $fetch['password']?>" type = "password" required data-parsley-length="[6, 12]" data-parsley-trigger="keyup">
						</div>
						<div class = "form-group">
							<label for = "firstname">Firstname: </label>
							<input class = "form-control" type = "text" value = "<?php echo $fetch['firstname']?>" name = "firstname" required data-parsley-pattern="^[a-zA-Z ]+$"data-parsley-trigger="keyup">
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">
							...
							<input class = "form-control" type = "text" value = "<?php echo $fetch['lastname']?>" name = "lastname" required data-parsley-pattern="^[a-zA-Z ]+$"data-parsley-trigger="keyup">
						</div>
						<div class = "form-group">
