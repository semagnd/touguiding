	 <div class="header-top">
		 <!--container-->
		  <div class="container">
			 <div class="top-nav">
						<div class="logo">
						<a href="#"><img src="images/logo.svg" id="section-1" class="img-responsive" alt=""/></a>
						</div>
						<div class="menu">
						<ul id="nav">
						<li><a href="register.php"onclick="javascript:window.open('register.php','_self')">Tourist registration</a></li>
							 ...
							 <li><a href="login.php"onclick="javascript:window.open('login.php','_self')">Login</a></li>
