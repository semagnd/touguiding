...
$user=new  User();
$stmt=$user->runQuery("SELECT * from booktour") or die(mysqli_error());
while($row=$stmt->fetch_array())
{
$status=$row['depurture'];
$date=date("Y-m-d");
$num=strtotime($date);
$backdate1=strtotime($status);
if($backdate1>$num)
{
$sql=$user->runQuery("Select * from booktour where status='notenter'" ) or die(mysqli_error());

while($row1=$sql->fetch_array())
{
$date1=$row1['depurture'];
$name=$row['name'];
$gname=$row['gname'];
$hname=$row['hname'];
...
$user->runQuery("delete * from booktour where depurture='$date1'") or die(mysqli_error());
}
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						...
						<h5 style="color:#000"><span class="img1"></span>(+251) 942721773&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+251) 937674685</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">info@ethiopiantour.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support@ethiopiantour.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>1100 High Street, Model To Town addiss ababa.</h5>
                        <br/>
