				...
				<form id = "form_admin" method = "POST" enctype = "multi-part/form-data" >
					...
					<div class = "panel-body">
						<div class = "form-group">
							...
							<input class = "form-control" name = "username" type = "text" required data-parsley-pattern="^[a-zA-Z ]+$">
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">	
							...
							<input class = "form-control" name = "password" maxlength = "12" type = "password" required data-parsley-length="[6, 15]" data-parsley-trigger="keyup">
						</div>
						<div class = "form-group">
							<label for = "firstname">Firstname: </label>
							<input class = "form-control" type = "text" name = "firstname" required data-parsley-pattern="^[a-zA-Z ]+$">
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">
							...
							<input class = "form-control" type = "text" required data-parsley-pattern="^[a-zA-Z ]+$">
						</div>
				...
				<table id = "table" class = "display" cellspacing = "0"  >
					...
					?>
						<tr>
							...
							<td><center><a class = "btn btn-sm btn-warning" href = "edit_admin.php?id=<?php echo $fetch['user_id']?>&lastname=<?php echo $fetch['lastname']?>"><i class = "glyphicon glyphicon-edit"></i> Update</a> <a onclick="confirmationDelete(this);return false;" href = "delete_admin.php?id=<?php echo $fetch['user_id']?>" class = "btn btn-sm btn-danger"><i class = "glyphicon glyphicon-remove"></i> Delete</a></center></td>
						</tr>
					<?php
						}
