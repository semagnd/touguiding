...
if(isset($_GET['id']) && isset($_GET['code']))
{
	...
	$stmt = $user->runQuery("SELECT * FROM user WHERE user_id='$id' AND tokenCode='$code'");
	...
	if($stmt->num_rows == 1)
	{
		if(isset($_POST['btn-reset-pass']))
		{
			...
			{
				$password = $user->encrypt($cpass);
				$uid=$rows['user_id'];
				$stmt = $user->runQuery("UPDATE user SET password='$password' WHERE user_id='$uid'") or die(mysqli_error());
